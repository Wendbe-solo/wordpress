...
<?php
 $tech_software_company_shop_page_sidebar = get_theme_mod( 'tech_software_company_shop_page_sidebar',true );
 if ( false == $tech_software_company_shop_page_sidebar ) {
...
<div class="container">
	<main role="main" id="maincontent">
		<div class="row m-0">
			...
			<?php if ( false != $tech_software_company_shop_page_sidebar ) {?>
