<?php 
$related_posts = tech_software_company_related_posts();

if(get_theme_mod('tech_software_company_show_related_post',true)==1){ ?>
<?php if ( $related_posts->have_posts() ): ?>
    <div class="related-posts">
        <?php if ( get_theme_mod('tech_software_company_related_post_title','Related Posts') != '' ) {?>
            <h3 class="mb-3"><?php echo esc_html( get_theme_mod('tech_software_company_related_post_title',__('Related Posts','tech-software-company')) ); ?></h3>
        <?php }?>
        <div class="row">
