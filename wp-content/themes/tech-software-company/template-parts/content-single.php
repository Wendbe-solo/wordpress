...
<article class="page-box-single p-3">
  <div class="new-text">
    <h1><?php the_title(); ?></h1>
    <?php if( get_theme_mod( 'tech_software_company_show_featured_image_single_post',true) != '') { ?>
      <div class="box-img">
    ...
    <?php if( get_theme_mod( 'tech_software_company_tags_hide',true) != '') { ?>
    ...
    the_post_navigation( array(
      'next_text' => '<span class="meta-nav text-uppercase p-2" aria-hidden="true">' . __( 'Next <i class="far fa-long-arrow-alt-right"></i> ', 'tech-software-company' ) . '</span> ' .
        '<span class="screen-reader-text">' . __( 'Next post:', 'tech-software-company' ) . '</span> ',
      'prev_text' => '<span class="meta-nav text-uppercase p-2" aria-hidden="true">' . __( '<i class="far fa-long-arrow-alt-left"></i> Previous', 'tech-software-company' ) . '</span> ' .
