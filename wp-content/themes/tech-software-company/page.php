...
<?php do_action( 'tech_software_company_page_header' ); ?>

<main role="main" id="maincontent" class="middle-align">
    <div class="container">
        <?php
        $tech_software_company_left_right = get_theme_mod( 'tech_software_company_single_page_sidebar_layout','One Column');
...
<?php do_action( 'tech_software_company_page_footer' ); ?>
